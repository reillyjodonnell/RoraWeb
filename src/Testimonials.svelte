...
<div class="testimonials">
  <div class="testimonial-container">
    <div class="testimonial-prompt">
      ...
      <h2>Check out what others are saying about Rora Web</h2>
      <span
        >Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus
        eius nisi, vel quod neque consectetur iste dolor eaque, error expedita
        doloribus ab suscipit aliquid provident temporibus molestiae iure ex
        mollitia?</span
      >
      <div class="arrow">
        <svg
    ...
    <div class="blob-quote">
      ...
      >
        <defs>
          <linearGradient
            ...
            y2=".7"
          >
            <stop offset="0%" stop-color="rgba(75, 52, 235, 1)" />
            <stop offset="80%" stop-color="rgba(83, 134, 236, 1)" />
            <stop offset="100%" stop-color="rgba(77, 189, 188, 1)" />
          </linearGradient>
        </defs>
        <path
          fill="url(#gradient)"
          d="M28.3,-37.2C41.9,-35.4,61.6,-36.3,74.2,-28.1C86.8,-20,92.4,-3,87.6,10.8C82.8,24.5,67.6,34.9,55.4,46.7C43.2,58.5,34,71.7,20.8,79.6C7.5,87.5,-9.9,90.2,-23.2,84C-36.6,77.9,-46,62.9,-55.8,49.5C-65.5,36.1,-75.7,24.2,-80.6,9.8C-85.5,-4.7,-85.1,-21.7,-78.1,-35.1C-71.1,-48.5,-57.5,-58.4,-43.4,-60C-29.2,-61.5,-14.6,-54.8,-3.6,-49.2C7.4,-43.6,14.8,-39.1,28.3,-37.2Z"
          transform="translate(100 60)"
        />
      </svg>
      <span class="review"
        >"Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suscipit,
        tempora dolorum laborum, molestias nobis culpa veritatis eveniet
        delectus saepe accusantium accusamus minus rem modi necessitatibus
        minima in atque excepturi molestiae possimus."</span
      >
      <div class="user">
        <svg
          class="avatar"
                ...
                ><g id="Mask" /><g
                  ...
                  ><g id="Top" stroke-width="1" fill-rule="evenodd"
                    ...
                    ><mask id="react-mask-59" fill="white"
                      ><use xlink:href="#react-path-61" /></mask
                    ><g id="Mask" /><g
                      id="Top/Short-Hair/Short-Round"
                      mask="url(#react-mask-59)"
                      ><g transform="translate(-1.000000, 0.000000)"
                        ><mask id="react-mask-58" fill="white"
                          ><use xlink:href="#react-path-60" /></mask
                        ><use
                          id="Short-Hair"
                          stroke="none"
                          fill="#28354B"
                          fill-rule="evenodd"
                          xlink:href="#react-path-60"
                        /><g
                          id="Skin/👶🏽-03-Brown"
      ...
      >
        <defs>
          <linearGradient
            gradientTransform="rotate(-105)"
            id="small"
            x2="0.75"
            y2=".7"
          >
            <stop offset="0%" stop-color="rgba(75, 52, 235, 1)" />
            <stop offset="44%" stop-color="rgba(83, 134, 236, 1)" />
          </linearGradient>
        </defs>
        <path
          fill="url(#small)"
          d="M63.4,-23.4C71.5,4.4,60,35.6,38.6,50.7C17.1,65.8,-14.5,64.6,-32.8,50.1C-51.1,35.7,-56.2,7.9,-48.5,-19.3C-40.8,-46.5,-20.4,-73.2,3.6,-74.4C27.6,-75.6,55.3,-51.2,63.4,-23.4Z"
...
<style>
  ...
  .tab {
    color: #02b7a2;
    background-color: rgba(2, 183, 162, 0.23);
    width: fit-content;
